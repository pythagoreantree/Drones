...
Just as the mobile phone allowed developing countries to leapfrog older technologies for personal communication, the drone has the potential 
...
- Project must have a README file with build/run/test instructions;
